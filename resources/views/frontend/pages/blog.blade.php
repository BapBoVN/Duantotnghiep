...
@section('title','Little Brain || Tin tức')
                        ...
                        {{-- {{$post}} --}}
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <img src="{{$post->photo}}" alt="{{$post->photo}}">
                                    <div class="content">
                                        <p class="date"><i class="fa fa-calendar" aria-hidden="true"></i> {{$post->created_at->locale('vi')->isoFormat('DD MMMM, YYYY')}}
                            ...
                            @foreach($recent_posts as $post)
                                ...
                                <div class="single-post">
                                    ...
                                    <div class="content">
                                        ...
                                        <ul class="comment">
                                            <li><i class="fa fa-calendar" aria-hidden="true"></i>{{$post->created_at->locale('vi')->isoFormat('DD MMMM, YYYY')}}</li>
