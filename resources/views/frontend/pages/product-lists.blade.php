					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="javascript:void(0);">Danh sách</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									<h3 class="title">Sắp xếp theo giá</h3>
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Sản phẩm mới đây</h3>
                                    {{-- {{dd($recent_products)}} --}}
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            <div class="image">
                                                <img src="{{$photo[0]}}" alt="{{$photo[0]}}" style="width: 80px; height: 110px; object-fit: cover; border-radius: 0;">
                                            </div>
                                            <div class="content">
										...
										<div class="shop-shorter">
											...
											<div class="single-shorter">
												...
												<select class='sortBy' name='sortBy' onchange="this.form.submit();">
													...
													<option value="price_asc" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='price_asc') selected @endif>Giá: Thấp đến cao</option>
													<option value="price_desc" @if(!empty($_GET['sortBy']) && $_GET['sortBy']=='price_desc') selected @endif>Giá: Cao đến thấp</option>
