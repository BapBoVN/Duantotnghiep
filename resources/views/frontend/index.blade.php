...
@section('title','Little Brain || Trang chủ')
                ...
                @foreach($posts as $post)
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            ...
                            <div class="content">
                                <p class="date">{{$post->created_at->locale('vi')->format('d/m/Y')}}</p>
                                <a href="{{route('blog.detail',$post->slug)}}" class="title">{{$post->title}}</a>
                                <a href="{{route('blog.detail',$post->slug)}}" class="more-btn">Đọc chi tiết</a>
                            </div>
                        </div>
                        <!-- End Single Blog  -->
                    </div>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            ...
                                            <div class="quickview-stock">
                                                @if($product->stock >0)
                                                <span><i class="fa fa-check-circle-o"></i> Còn {{$product->stock}} sản phẩm</span>
                                                @else
