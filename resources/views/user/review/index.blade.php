...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Danh sách đánh giá sản phẩm</h6>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($reviews as $review)
                <tr>
                    ...
                    <td>{{$review->created_at->locale('vi')->isoFormat('DD MMMM, YYYY')}} lúc {{$review->created_at->format('H:i')}}</td>
                    <td>
