<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Cài đặt danh mục</h6>
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Cài đặt thương hiệu</h6>
    ...
    <li class="nav-item">
     ...
     <li class="nav-item">
        ...
        <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Quản lý danh mục bài viết</h6>
            <a class="collapse-item" href="{{route('post-category.index')}}">Danh mục bài viết</a>
            <a class="collapse-item" href="{{route('post-category.create')}}">Thêm mới danh mục</a>
          </div>
        </div>
      </li>
    ...
    <!-- <li class="nav-item">
     ...
     <li class="nav-item">
        <a class="nav-link" href="{{route('message.index')}}">
            <i class="fas fa-envelope fa-chart-area"></i>
            <span>Tin nhắn</span>
        </a>
    </li>
     <!-- General settings -->
