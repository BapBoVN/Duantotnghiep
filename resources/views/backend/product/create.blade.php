...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Mô tả<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">Chi tiết</label>
        ...
        <div class="form-group">
          <label for="condition">Nhãn</label>
        ...
        <div class="form-group mb-3">
         ...
         <button type="reset" class="btn btn-warning">Chọn lại</button>
