...
class FrontendController extends Controller
{
    ...
    public function loginSubmit(Request $request){
        ...
        if(Auth::attempt(['email' => $data['email'], 'password' => $data['password'],'status'=>'active'])){
            ...
            request()->session()->flash('error','Tên đăng nhập hoặc mật khẩu không đúng, hãy thử lại!');
    ...
    public function showNewPasswordForm(Request $request)
    {
        ...
        if (!$resetRecord) {
            return redirect()->route('password.form')->with('error', 'Link đặt lại mật khẩu không hợp lệ.');
        }
    ...
    public function updatePassword(Request $request)
    {
        ...
        return redirect()->route('login.form')->with('success', 'Mật khẩu của bạn đã được thay đổi!');
    }
